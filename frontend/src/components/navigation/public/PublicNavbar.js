			...
			>
				...
				<div className="hidden lg:flex items-center lg:flex-1 lg:justify-end">
					<a
						href="/"
						type="submit"
						className="flex justify-center rounded-full bg-blue-600 px-5 py-2 mr-3 font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
					>
						Create Article
					</a>
